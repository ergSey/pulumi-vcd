...
export class MultisiteOrgAssociation extends pulumi.CustomResource {
     ...
     * (Used instead of `associatedData`). This file can be created (by the other org administrator) using the data source `vcd.getMultisiteOrgData`.
     */
    ...
    constructor(name: string, argsOrState?: MultisiteOrgAssociationArgs | MultisiteOrgAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MultisiteOrgAssociation.__pulumiType, name, resourceInputs, opts);
    }
}

...
export function getLibraryCertificateOutput(args?: GetLibraryCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLibraryCertificateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("vcd:index/getLibraryCertificate:getLibraryCertificate", {
        "alias": args.alias,
        "certificate": args.certificate,
        "description": args.description,
        "id": args.id,

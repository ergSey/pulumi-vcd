...
namespace Pulumi.Vcd
{
    ...
    public partial class Provider : global::Pulumi.ProviderResource
    {
        ...
        /// </summary>
        [Output("samlAdfsCookie")]
        public Output<string?> SamlAdfsCookie { get; private set; } = null!;
        ...
        /// </summary>
        [Output("serviceAccountTokenFile")]
        public Output<string?> ServiceAccountTokenFile { get; private set; } = null!;
    ...
    public sealed class ProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("allowApiTokenFile", json: true)]
        public Input<bool>? AllowApiTokenFile { get; set; }

        /// <summary>
        /// Set this to true if you understand the security risks of using Service Account token files and would like to suppress
        /// the warnings
        /// </summary>
        [Input("allowServiceAccountTokenFile", json: true)]
        public Input<bool>? AllowServiceAccountTokenFile { get; set; }
        ...
        [Input("ignoreMetadataChanges", json: true)]
        private InputList<Inputs.ProviderIgnoreMetadataChangeArgs>? _ignoreMetadataChanges;

        /// <summary>
        /// Defines a set of `metadata_entry` that need to be ignored by this provider. All filters on this attribute are computed
        /// with a logical AND
        /// </summary>
        public InputList<Inputs.ProviderIgnoreMetadataChangeArgs> IgnoreMetadataChanges
        {
            get => _ignoreMetadataChanges ?? (_ignoreMetadataChanges = new InputList<Inputs.ProviderIgnoreMetadataChangeArgs>());
            set => _ignoreMetadataChanges = value;
        }
        ...
        /// sso_redirect_org={{.Org}}'
        /// </summary>
        [Input("samlAdfsCookie")]
        public Input<string>? SamlAdfsCookie { get; set; }
        ...
        /// The Service Account API token file instead of username/password for VCD API operations. (Requires VCD 10.4.0+)
        /// </summary>
        [Input("serviceAccountTokenFile")]
        public Input<string>? ServiceAccountTokenFile { get; set; }

...
type NsxtDistributedFirewall struct {
	...
	Rules NsxtDistributedFirewallRuleTypeArrayOutput `pulumi:"rules"`
...
type nsxtDistributedFirewallState struct {
	...
	//
	// <a id="firewall-rule"></a>
	Rules []NsxtDistributedFirewallRuleType `pulumi:"rules"`
	// The ID of VDC Group to manage Distributed Firewall in. Can be looked
	// up using `VdcGroup` resource or data source.
...
type NsxtDistributedFirewallState struct {
	...
	//
	// <a id="firewall-rule"></a>
	Rules NsxtDistributedFirewallRuleTypeArrayInput
	// The ID of VDC Group to manage Distributed Firewall in. Can be looked
	// up using `VdcGroup` resource or data source.
...
//
// <a id="firewall-rule"></a>
func (o NsxtDistributedFirewallOutput) Rules() NsxtDistributedFirewallRuleTypeArrayOutput {
	return o.ApplyT(func(v *NsxtDistributedFirewall) NsxtDistributedFirewallRuleTypeArrayOutput { return v.Rules }).(NsxtDistributedFirewallRuleTypeArrayOutput)
}

...
func LookupCatalogMediaOutput(ctx *pulumi.Context, args LookupCatalogMediaOutputArgs, opts ...pulumi.InvokeOption) LookupCatalogMediaResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCatalogMediaResultOutput, error) {
			args := v.(LookupCatalogMediaArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("vcd:index/getCatalogMedia:getCatalogMedia", args, LookupCatalogMediaResultOutput{}, options).(LookupCatalogMediaResultOutput), nil
...
func (o LookupCatalogMediaResultOutput) CatalogItemId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCatalogMediaResult) string { return v.CatalogItemId }).(pulumi.StringOutput)
}
...
func (o LookupCatalogMediaResultOutput) DownloadToFile() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupCatalogMediaResult) *string { return v.DownloadToFile }).(pulumi.StringPtrOutput)
}
...
// Deprecated: Use metadataEntry instead
func (o LookupCatalogMediaResultOutput) Metadata() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupCatalogMediaResult) map[string]string { return v.Metadata }).(pulumi.StringMapOutput)
}

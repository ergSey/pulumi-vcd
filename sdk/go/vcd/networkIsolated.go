...
//
// Deprecated: Use metadataEntry instead
func (o NetworkIsolatedOutput) Metadata() pulumi.StringMapOutput {
	return o.ApplyT(func(v *NetworkIsolated) pulumi.StringMapOutput { return v.Metadata }).(pulumi.StringMapOutput)
}

...
type Vm struct {
	...
	BootOptions VmBootOptionsOutput `pulumi:"bootOptions"`
	...
	// Custom priority for the resource. This is a read-only, unless the `cpuPriority` is CUSTOM
	...
	ExtraConfigs VmExtraConfigArrayOutput `pulumi:"extraConfigs"`
	// Firmware of the VM. Can be either EFI or BIOS, availabilitydepending on the osType argument. If unset, is set to 'bios'
	// by default. Changing the value when `powerOn` is set to true, will cause a reboot of the VM.
	...
	// Custom priority for the resource. This is a read-only, unless the `memoryPriority` is CUSTOM
	...
	// A block to match internalDisk interface in template. Multiple can be used. Disk will be matched by bus_type, busNumber
	// and unit_number.
	...
	SetExtraConfigs VmSetExtraConfigArrayOutput `pulumi:"setExtraConfigs"`
...
type vmState struct {
	...
	// A block defining the boot options of a VM
	BootOptions *VmBootOptions `pulumi:"bootOptions"`
	// The catalog name in which to find the given vApp Template or media for boot_image
	//
	// Deprecated: You should use `vappTemplateId` or `bootImageId` without the need of a catalog name
	...
	// A block to retrieve extra configuration key-value pairs
	ExtraConfigs []VmExtraConfig `pulumi:"extraConfigs"`
	// Firmware of the VM. Can be either EFI or BIOS, availabilitydepending on the osType argument. If unset, is set to 'bios'
	// by default. Changing the value when `powerOn` is set to true, will cause a reboot of the VM.
	...
	// A block to set extra configuration key-value pairs
	SetExtraConfigs []VmSetExtraConfig `pulumi:"setExtraConfigs"`
	// VM sizing policy ID. Has to be assigned to Org VDC.
...
type VmState struct {
	...
	// A block defining the boot options of a VM
	BootOptions VmBootOptionsPtrInput
	// The catalog name in which to find the given vApp Template or media for boot_image
	//
	// Deprecated: You should use `vappTemplateId` or `bootImageId` without the need of a catalog name
	...
	// A block to retrieve extra configuration key-value pairs
	ExtraConfigs VmExtraConfigArrayInput
	// Firmware of the VM. Can be either EFI or BIOS, availabilitydepending on the osType argument. If unset, is set to 'bios'
	// by default. Changing the value when `powerOn` is set to true, will cause a reboot of the VM.
	...
	// A block to set extra configuration key-value pairs
	SetExtraConfigs VmSetExtraConfigArrayInput
	// VM sizing policy ID. Has to be assigned to Org VDC.
...
// A block defining the boot options of a VM
func (o VmOutput) BootOptions() VmBootOptionsOutput {
	return o.ApplyT(func(v *Vm) VmBootOptionsOutput { return v.BootOptions }).(VmBootOptionsOutput)
}
...
// Consolidates disks during creation and allows to change disk size using 'override_template_disk' in fast provisioned
// VDCs
func (o VmOutput) ConsolidateDisksOnCreate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Vm) pulumi.BoolPtrOutput { return v.ConsolidateDisksOnCreate }).(pulumi.BoolPtrOutput)
}

// Source VM that should be copied from
func (o VmOutput) CopyFromVmId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringPtrOutput { return v.CopyFromVmId }).(pulumi.StringPtrOutput)
}
...
// A block to retrieve extra configuration key-value pairs
func (o VmOutput) ExtraConfigs() VmExtraConfigArrayOutput {
	return o.ApplyT(func(v *Vm) VmExtraConfigArrayOutput { return v.ExtraConfigs }).(VmExtraConfigArrayOutput)
}

// Firmware of the VM. Can be either EFI or BIOS, availabilitydepending on the osType argument. If unset, is set to 'bios'
// by default. Changing the value when `powerOn` is set to true, will cause a reboot of the VM.
func (o VmOutput) Firmware() pulumi.StringOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringOutput { return v.Firmware }).(pulumi.StringOutput)
}

// Key/value settings for guest properties
func (o VmOutput) GuestProperties() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringMapOutput { return v.GuestProperties }).(pulumi.StringMapOutput)
}
...
// Tells whether this resource has been imported
func (o VmOutput) Imported() pulumi.BoolOutput {
	return o.ApplyT(func(v *Vm) pulumi.BoolOutput { return v.Imported }).(pulumi.BoolOutput)
}

// A map that contains metadata that is automatically added by VCD (10.5.1+) and provides details on the origin of the VM
func (o VmOutput) InheritedMetadata() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringMapOutput { return v.InheritedMetadata }).(pulumi.StringMapOutput)
}
...
//
// Deprecated: Use metadataEntry instead
func (o VmOutput) Metadata() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringMapOutput { return v.Metadata }).(pulumi.StringMapOutput)
}
...
// Security tags to assign to this VM
func (o VmOutput) SecurityTags() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringArrayOutput { return v.SecurityTags }).(pulumi.StringArrayOutput)
}

// A block to set extra configuration key-value pairs
func (o VmOutput) SetExtraConfigs() VmSetExtraConfigArrayOutput {
	return o.ApplyT(func(v *Vm) VmSetExtraConfigArrayOutput { return v.SetExtraConfigs }).(VmSetExtraConfigArrayOutput)
}
...
// ID of parent vApp
func (o VmOutput) VappId() pulumi.StringOutput {
	return o.ApplyT(func(v *Vm) pulumi.StringOutput { return v.VappId }).(pulumi.StringOutput)
}

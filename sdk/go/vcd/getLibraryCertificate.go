...
func LookupLibraryCertificateOutput(ctx *pulumi.Context, args LookupLibraryCertificateOutputArgs, opts ...pulumi.InvokeOption) LookupLibraryCertificateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLibraryCertificateResultOutput, error) {
			args := v.(LookupLibraryCertificateArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("vcd:index/getLibraryCertificate:getLibraryCertificate", args, LookupLibraryCertificateResultOutput{}, options).(LookupLibraryCertificateResultOutput), nil
